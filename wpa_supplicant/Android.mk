...
ifeq ($(WIFI_DISPLAY_USE), y)
CONFIG_WIFI_DISPLAY = y
endif

ifndef CONFIG_WIFI_DISPLAY

ifeq ($(SW_BOARD_USR_WIFI), eagle)
L_CFLAGS += -DCONFIG_WFD
L_CFLAGS += -DANDROID_P2P
L_CFLAGS += -DWIFI_EAGLE
endif
...
#LOCAL_STATIC_LIBRARIES := lib_driver_cmd_eagle
...
########################
include $(CLEAR_VARS)
LOCAL_MODULE := wpa_supplicant_eagle
LOCAL_STATIC_LIBRARIES := lib_driver_cmd_eagle
...
include $(CLEAR_VARS)
LOCAL_MODULE = libwpa_client_eagle
LOCAL_CFLAGS = $(L_CFLAGS)
